    ...
    try {
        ...
        if ((int)$lapakCount === 0) {
            $sPdo->exec("
                ...
                ('lapak_003', 'usr_m3_003', 'LAPAK-2026-003', 'Budi Aksesoris', 'Spesialis aksesoris interior & eksterior Mercedes-Benz klasik & modern', 'Aksesoris', '021-9988776', '081355443322', 'https://images.unsplash.com/photo-1552519507-da3b142c6e3d?w=300', 'https://images.unsplash.com/photo-1563720223185-11003d516935?w=1200', '2026-02-01', '2026-07-31', 'EXPIRED', 28500, 30000, 5, 28500, 'PAID', FALSE, TRUE, 'usr_superadmin');
            ");

            // Seed Products
            $sPdo->exec("
                INSERT INTO lapak_products (id, lapak_id, name, description, price, condition, location, images, views, status, rejection_reason) VALUES
                ('prod_001', 'lapak_001', 'Velg AMG 18\" Monoblock', 'Velg AMG 18\" Monoblock original kondisi 90%, ban Michelin masih 80%. Cocok untuk W124 / W210 / W211.', 15000000, 'USED', 'Jakarta Selatan', '[\"https://images.unsplash.com/photo-1580273916550-e323be2ae537?w=600\"]', 142, 'APPROVED', NULL),
                ('prod_002', 'lapak_001', 'Filter Udara W124 Original Mann', 'Filter udara kualitas Jerman original Mann-Filter untuk W124 Boxer 300E / E320.', 350000, 'NEW', 'Jakarta Pusat', '[\"https://images.unsplash.com/photo-1486006920555-c77dce18193b?w=600\"]', 88, 'APPROVED', NULL),
                ('prod_003', 'lapak_001', 'Bushing Arm W211 Lemforder', 'Bushing arm depan set kanan-kiri Lemforder W211 E-Class baru gress.', 250000, 'NEW', 'Jakarta Selatan', '[\"https://images.unsplash.com/photo-1517524008697-84bbe3c3fd98?w=600\"]', 65, 'APPROVED', NULL),
                ('prod_004', 'lapak_001', 'Cover Headlamp W204 C-Class', 'Cover lampu utama transparan OEM W204 facelift mulus tanpa retak.', 750000, 'USED', 'Jakarta Barat', '[\"https://images.unsplash.com/photo-1503376780353-7e6692767b70?w=600\"]', 94, 'APPROVED', NULL),
                ('prod_005', 'lapak_002', 'Kaos Polo MB INA Official 2026', 'Kaos polo katun combed 30s bermutu tinggi dengan bordir logo emas MB INA.', 150000, 'NEW', 'Surabaya', '[\"https://images.unsplash.com/photo-1521572267360-ee0c2909d518?w=600\"]', 210, 'APPROVED', NULL),
                ('prod_006', 'lapak_002', 'Gantungan Kunci Kulit Genuine MB INA', 'Gantungan kunci bahan kulit sapi asli dengan logo embossing MB INA.', 45000, 'NEW', 'Surabaya', '[\"https://images.unsplash.com/photo-1618354691373-d851c5c3a990?w=600\"]', 130, 'APPROVED', NULL),
                ('prod_007', 'lapak_003', 'Emblem Grille Bintang Mercedes-Benz Chrome', 'Emblem grill bintang tiga titik chrome mengkilap cocok untuk tipe W202 W203 W210.', 120000, 'NEW', 'Bandung', '[\"https://images.unsplash.com/photo-1552519507-da3b142c6e3d?w=600\"]', 45, 'PENDING', NULL);
            ");
...
function ensureM8Tables($sPdo) {
    ...
    try {
        ...
        if ((int)$campaignCount === 0) {
            $sPdo->exec("
                INSERT INTO ad_campaigns (id, name, type, partner_name, budget, spent, start_date, end_date, impressions_target, clicks_target, impressions_current, clicks_current, ctr, status, notes, created_by) VALUES
                ('ac_hella', 'Banner Hella LED Lighting Promo', 'BANNER', 'Hella Asia', 4500000, 3200000, '2026-08-05', '2026-09-05', 30000, 3000, 15400, 1420, 9.22, 'ACTIVE', 'Promo lampu LED Hella grade premium', 'usr_superadmin'),
                ('ac_meguiars', 'Native Ad Ceramic Coating Meguiars', 'NATIVE', 'Meguiar\'s Indonesia', 6500000, 0, '2026-09-15', '2026-10-15', 40000, 4000, 0, 0, 0, 'DRAFT', 'Coating ceramic khusus bodi Mercedes-Benz', 'usr_superadmin'),
                ('ac_wurth', 'Banner Wurth Maintenance Spray', 'BANNER', 'Wurth Indonesia', 3500000, 3500000, '2026-04-01', '2026-05-31', 25000, 2500, 25000, 2100, 8.40, 'EXPIRED', 'Penetrant & rust remover Wurth', 'usr_superadmin'),
                ('sp_001', 'Sponsorship Principal OEM Mercedes-Benz', 'SPONSOR', 'PT Mercedes-Benz Distribution Indonesia', 50000000, 45000000, '2026-01-01', '2026-12-31', 100000, 10000, 85000, 9200, 10.82, 'ACTIVE', 'APM Resmi Mercedes-Benz di Indonesia. Dukungan jaringan suku cadang original, garansi, & technical support kegiatan MB INA.|Official Automaker Principal|💎 SPONSOR UTAMA PLATINUM|https://images.unsplash.com/photo-1618843479313-40f8afb4b4d8?w=300', 'usr_superadmin'),
                ('sp_002', 'Co-Branding Banking & E-KTA BNI', 'SPONSOR', 'PT Bank Negara Indonesia (Persero) Tbk', 40000000, 35000000, '2026-01-01', '2026-12-31', 80000, 8000, 62000, 7100, 11.45, 'ACTIVE', 'Mitra Perbankan Resmi MB Club Indonesia & Penerbit Co-Branding Kartu Anggota E-KTA Smart Card BNI TapCash / Credit Card.|Official Banking & E-KTA Partner|💎 SPONSOR UTAMA PLATINUM|https://images.unsplash.com/photo-1541354329998-f4d9a9f9297f?w=300', 'usr_superadmin'),
                ('sp_003', 'Pelumas Resmi Fastron Platinum Series', 'SPONSOR', 'PT Pertamina Lubricants (Pertamina Fastron)', 35000000, 30000000, '2026-01-01', '2026-12-31', 75000, 7500, 54000, 5800, 10.74, 'ACTIVE', 'Pelumas Resmi Fastron Platinum Synthetic Series untuk Perlindungan Mesin High Performance Mercedes-Benz modern & klasik.|Official Lubricant Partner|💎 PLATINUM SPONSOR|https://images.unsplash.com/photo-1527016016007-57ad3655638f?w=300', 'usr_superadmin'),
                ('sp_004', 'Ban Resmi Michelin Pilot Sport', 'SPONSOR', 'PT Michelin Indonesia', 30000000, 25000000, '2026-01-01', '2026-12-31', 60000, 6000, 48000, 5100, 10.63, 'ACTIVE', 'Ban Resmi Michelin Pilot Sport Series untuk Performabilitas, Traksi, & Keselamatan Utama Anggota MB INA.|Official Tire & Safety Partner|💎 PLATINUM SPONSOR|https://images.unsplash.com/photo-1578844251758-2f71da64c96f?w=300', 'usr_superadmin'),
                ('sp_005', 'Payment Gateway Livin Bank Mandiri', 'SPONSOR', 'PT Bank Mandiri (Persero) Tbk', 30000000, 28000000, '2026-01-01', '2026-12-31', 60000, 6000, 45000, 4900, 10.89, 'ACTIVE', 'Layanan Pembayaran Digital Livin\' & Financial Sponsorship Program Event Jamnas & Gathering Nasional MB INA 2026.|Official Digital Payment Partner|💎 PLATINUM SPONSOR|https://images.unsplash.com/photo-1601597111158-2fceff292cdc?w=300', 'usr_superadmin'),
                ('sp_006', 'High Octane Fuel Shell V-Power', 'SPONSOR', 'PT Shell Indonesia', 25000000, 22000000, '2026-01-01', '2026-12-31', 50000, 5000, 39000, 4200, 10.77, 'ACTIVE', 'Bahan Bakar High Octane Shell V-Power & Program Cash-back Loyalty Shell ClubSmart khusus Anggota MB Club INA.|Official Fuel & Energy Partner|💎 PLATINUM SPONSOR|https://images.unsplash.com/photo-1542282088-72c9c27ed0cd?w=300', 'usr_superadmin'),
                ('sp_007', 'Pelumas Castrol EDGE Fluid TITANIUM', 'SPONSOR', 'PT Castrol Indonesia', 25000000, 20000000, '2026-01-01', '2026-12-31', 50000, 5000, 37000, 3900, 10.54, 'ACTIVE', 'Pelumas Castrol EDGE Fluid TITANIUM Technology untuk Proteksi Ekstrem Mesin Mercedes-Benz AMG & Kompressor.|Official Performance Fluid Partner|💎 PLATINUM SPONSOR|https://images.unsplash.com/photo-1503376780353-7e6692767b70?w=300', 'usr_superadmin'),
                ('sp_008', 'Pelumas Transmisi TotalEnergies', 'SPONSOR', 'PT TotalEnergies Marketing Indonesia', 20000000, 18000000, '2026-01-01', '2026-12-31', 40000, 4000, 31000, 3400, 10.97, 'ACTIVE', 'Formulasi Khusus Pelumas Transmisi & Drivetrain Teruji untuk Seluruh Lini Kendaraan Mercedes-Benz.|Specialty Drivetrain Fluid Partner|💎 PLATINUM SPONSOR|https://images.unsplash.com/photo-1511919884226-fd3cad34687c?w=300', 'usr_superadmin');
            ");
        }
